  ...
  return (
    <>
      ...
      <div className='about_parent_container'>
        <h1 className='heading'> About Bhumika</h1>
          ...
          <div className='About_right_contianer'>
            <div className='About_right_Content'>
              ...
              <h5>
                ...
                I specialise in weight menagement & PCOS. i AM also a member of
                The PCOS Society, India.
              </h5>
              <h5>
                My approach is pesonalised & evidence based. I have helped
                hundreds of clients globally to take charge of their health
                through simple changes in diet and lifestyle.
              </h5>
              <h5>
                My philosopy is simple. When it comes to food, nothing is off
                the table. I help my clinets transform their fitness by finding
                the right balance in their lives and equipping hem for lifelong
                success.
              </h5>
              <h5>
